...
const Appbar = () => {
  return (
    <div className="border-b flex justify-between px-10 py-1">
        ...
        <div>
            <Link to={"/publish"}>
                <button type="button" className="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-3xl text-sm px-5 py-2.5 me-2 mb-2 mt-2">Create Blog</button>
            </Link>
